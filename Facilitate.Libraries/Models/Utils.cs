...
namespace Facilitate.Libraries.Models
{
    public class Utils
    {
        ...
        public async Task<ZipCode> GetRandomZipCodeAsync(ObjectId cityId, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                randomZipCodes = await zipCodeCollection.Find(s => s._t == "ZipCode").ToListAsync(ct);
